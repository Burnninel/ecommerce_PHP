...
<section class="swiper bannerBestSellers mb-[4vh]">
    ...
    <div class="swiper-wrapper flex items-center h-full w-full">
        <?php foreach ($produtos as $bestSellers): ?>
            <?php if ($bestSellers["bestSeller"] === true): ?>
                <article class="swiper-slide flex w-[calc(25%)] justify-around cursor-pointer">
                    <a href="produto?id=<?= $bestSellers['id'] ?>" class="w-full">
                        <div class="relative h-[45vw] sm:h-[35vw] md:h-[30vw] lg:h-[25vw]">
                            <img src="/img/<?= $bestSellers['categoria'] ?>/<?= $bestSellers['imagens']['frente'] ?>.png" alt="Imagem da frente" class="absolute inset-0 w-full h-full object-cover transition-opacity duration-500 hover:opacity-0">
                            <img src="/img/<?= $bestSellers['categoria'] ?>/<?= isset($bestSellers['imagens']['adicional2']) ? $bestSellers['imagens']['adicional2'] : $bestSellers['imagens']['adicional'] ?>.png" alt="Imagem de costas" class="absolute inset-0 w-full h-full object-cover transition-opacity duration-500 opacity-0 hover:opacity-100">
                        </div>
