            ...
            <li class="w-[calc(25%-1vh)] cursor-pointer">
                <a href="produto?id=<?=$item['id'] ?>">
                    <div class="relative h-[22vw]">
                        <img src="/img/<?= $categoria ?>/<?= $item['imagens']['frente'] ?>.png" alt="Imagem da frente" class="absolute inset-0 w-full h-full items-center text-center transition-opacity duration-500 hover:opacity-0">
                        <img src="/img/<?= $categoria ?>/<?= $item['imagens']['adicional'] ?>.png" alt="Imagem de costas" class="absolute inset-0 w-full h-full transition-opacity duration-500 opacity-0 hover:opacity-100">
                    </div>
